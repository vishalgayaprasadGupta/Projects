...
public class fetchUserDetails extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_fetch_user_details, container, false);
                    ...
                    .addOnCompleteListener(task -> {
                        ...
                        if (task.isSuccessful() && !task.getResult().isEmpty()) {
                            ...
                            if("Active".equals(Status)){
                                ...
                                UpdateRole fragment = new UpdateRole();
                                Bundle bundle = new Bundle();
                                bundle.putString("uid", userId);
                                fragment.setArguments(bundle);
                                getFragment(fragment);
                            }else{
                                Toast.makeText(getActivity(), "User is Inactive!", Toast.LENGTH_SHORT).show();
                            }
                        } else {
