...
public class fetchUserDetailsandActivate extends Fragment {
    ...
    public fetchUserDetailsandActivate() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_fetch_user_detailsand_activate, container, false);
                    ...
                    .addOnCompleteListener(task -> {
                        ...
                        if (task.isSuccessful() && !task.getResult().isEmpty()) {
                            ...
                            if("Active".equals(Status)){
                                Toast.makeText(getActivity(), "User with Email : "+Email+" is already Active!", Toast.LENGTH_LONG).show();
                                email.setText("");
                                return;
                            }else {
                                Log.d("UpdateUser", "User found! UID: " + userId);
                                ActivateUser fragment = new ActivateUser();
