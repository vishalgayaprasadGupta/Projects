...
public class OrganiserInterCollegeEventList extends Fragment {
    ...
    public OrganiserInterCollegeEventList() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_organiser_inter_college_event_list, container, false);
