...
public class OrganiserInterCollegeEventListForDelete extends Fragment {
    ...
    public OrganiserInterCollegeEventListForDelete() {
    ...
    private void fetchEvents() {
        db.collection("InterCollege Events").whereEqualTo("eventStream", stream)
