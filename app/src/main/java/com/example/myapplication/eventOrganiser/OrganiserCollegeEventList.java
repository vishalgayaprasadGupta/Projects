...
public class OrganiserCollegeEventList extends Fragment {
    ...
    public OrganiserCollegeEventList() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_organiser_college_event_list, container, false);
    ...
    public void onItemClick(String eventId,String eventType,String eventName,String startDate,String endDate) {
        ...
        Log.d("UpdatePage", "Event ID: " + eventId);
