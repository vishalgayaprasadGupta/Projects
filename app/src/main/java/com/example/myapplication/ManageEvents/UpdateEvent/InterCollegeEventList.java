...
public class InterCollegeEventList extends Fragment {
    ...
    public InterCollegeEventList() {
        // Required empty public constructor
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_inter_college_event_list, container, false);
