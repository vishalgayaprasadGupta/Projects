...
public class InterCollegeActivityListAdapter extends RecyclerView.Adapter<InterCollegeActivityListAdapter.EventViewHolder> {
    private List<InterCollege> eventList;
    private OnItemClickListener listener; // Declare the listener

    public InterCollegeActivityListAdapter(List<InterCollege> eventList) {
