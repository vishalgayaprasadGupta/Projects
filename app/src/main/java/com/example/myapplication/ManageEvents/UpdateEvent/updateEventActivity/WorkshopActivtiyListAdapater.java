...
public class WorkshopActivtiyListAdapater extends RecyclerView.Adapter<WorkshopActivtiyListAdapater.EventViewHolder> {
    ...
    public WorkshopActivtiyListAdapater(List<Workshop> eventList) {
