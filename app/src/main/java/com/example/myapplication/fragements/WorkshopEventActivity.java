...
public class WorkshopEventActivity extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_workshop_event_activtiy, container, false);
        ...
        activityAdapter = new WorkshopActivtiyAdapater(new ArrayList<>());
                        ...
                        db.collection("EventActivities")
                                ...
                                .addOnCompleteListener(activityTask -> {
                                    if (activityTask.isSuccessful()) {
                                        List<Workshop> activities = new ArrayList<>();
                                        for (DocumentSnapshot document : activityTask.getResult()) {
                                            Workshop activity = document.toObject(Workshop.class);
                                        ...
                                        if (activities.isEmpty()) {
                                            ...
                                            activityAdapter = new WorkshopActivtiyAdapater(activities);
                                            activityAdapter.setOnItemClickListener(this::onItemClick);
                                            activityRecyclerView.setAdapter(activityAdapter);
                                        }
                                    } else {
