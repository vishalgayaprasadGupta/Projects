...
public class OrganiserRequestRecieveEmail {

    private static final String SENDGRID_API_KEY = BuildConfig.SENDGRID_API_KEY;
    private static String stream,department;
    public static void sendOrgnaiserRequestToAdmin(String Name,String Stream,String Department) {
        ...
        db.collection("User")
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        sendEmailToAdmins(adminEmails, Name,Stream,Department);
                    } else {
    ...
    private static void sendEmailToAdmins(List<String> adminEmails, String Name,String Stream,String Department) {
        ...
        String subject = "Action Required: New Event Organizer Registration Request";
        String message = "<html><body>" +
                "<p>Dear Admin,</p>" +
                "<p>A new user has requested approval for an <strong>Event Organizer</strong> role.</p>" +
                "<p><strong>Organizer Name:</strong> " + Name + "</p>" +
                "<p><strong>Stream:</strong> " + Stream + "</p>" +
                "<p><strong>Department:</strong> " + Department + "</p>" +
                "<p><strong>Requested On:</strong> " + timestamp + "</p>" +
                "<p>Please log in to the CampusConnect admin panel to review and take necessary action on this request.</p>" +
                "<p>If you have any questions, contact support at <a href='mailto:hub.campusconnect@gmail.com'>hub.campusconnect@gmail.com</a>.</p>" +
