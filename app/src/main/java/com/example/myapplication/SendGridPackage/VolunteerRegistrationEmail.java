...
public class VolunteerRegistrationEmail {

    private static final String SENDGRID_API_KEY = BuildConfig.SENDGRID_API_KEY;

    public static void volunteerRegistrationEmail(String toEmail, String volunteerName) {
        try {
            ...
            String subject = "Your Volunteer Request Has Been Forwarded for Review!";
            String adminEmail = "hub.campusconnect@gmail.com";
            String message = "<html><body>" +
                    "<h1>Campus Connect - Volunteer Request Submitted</h1>" +
                    "<p>Dear " + volunteerName + ",</p>" +
                    "<p>Thank you for applying to become a volunteer at Campus Connect!</p>" +
                    "<p>Your request has been successfully <strong>forwarded for review</strong> to our admin team.</p>" +
                    "<p><strong>Request Date:</strong> " + timestamp + "</p>" +
                    "<ul>" +
                    "<li>Your application is currently under review.</li>" +
                    "<li>Once approved, you will receive an email confirming your volunteer status.</li>" +
                    "<li>If any additional information is required, the admin may contact you.</li>" +
                    "</ul>" +
                    "<p>If you have any questions regarding your application, feel free to reach out to our admin team at: " +
                    "<a href='mailto:" + adminEmail + "'>" + adminEmail + "</a></p>" +
                    "<p>We appreciate your enthusiasm and look forward to working with you!</p>" +
